...
interface Props {
  href: string;
  publicId: string;
  source: "card" | "detail" | "sticky" | "similar" | "other";
  label?: string;
  className?: string;
  size?: "default" | "sm" | "lg";
}

/** Opens WhatsApp (wa.me) with the prefilled message and logs the click as an Inquiry. */
